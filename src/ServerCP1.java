...
public class ServerCP1 {
    ...
    public boolean getVerified() {
        ...
        try {
            ...
            // load the CA file
            File caFile = new File("certs/example.crt");
    ...
    private PrivateKey getPrivateKey() {
        try {
            byte[] keyByte = Files.readAllBytes(Paths.get("certs/private_key.der"));
    ...
    class WriteToDisk extends Thread {
        ...
        public void run() {
            try {
                FileOutputStream fileOutputStream = new FileOutputStream("receivedFiles/recv_" + name);
